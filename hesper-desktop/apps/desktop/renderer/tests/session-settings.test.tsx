...
const { listSessions, setWorkspace, setModel, setOutputMode, selectDirectory, onEvent, enqueue, stopRun, getSettings, updateSettings, listModels, listTools, setToolEnabled, listSkills, refreshSkills, listRoles } = vi.hoisted(() => ({
  ...
  getSettings: vi.fn(async () => ({ defaultModelId: 'pi/gpt-5.4-mini', defaultOutputMode: 'markdown', themeMode: 'dark', themeId: 'catppuccin', fontSize: 14, soul: '' })),
...
describe('session settings and restore flow', () => {
  ...
  beforeEach(() => {
    ...
    getSettings.mockResolvedValue({ defaultModelId: 'pi/gpt-5.4-mini', defaultOutputMode: 'markdown', themeMode: 'dark', themeId: 'catppuccin', fontSize: 14, soul: '' })
