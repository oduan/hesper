...
describe('SkillsPanel', () => {
  ...
  it('renders selected skill metadata and prompt', () => {
    ...
    expect(within(metadata).getByText('workspace:writer')).toBeInTheDocument()
  ...
  it('renders fallback text for missing description and prompt', () => {
    render(<SkillsPanel skills={[{ id: 'builtin:notes', name: '笔记', source: 'builtin' }]} selectedSkill={{ id: 'builtin:notes', name: '笔记', source: 'builtin' }} />)
