...
describe('renderer App', () => {
  ...
  beforeEach(() => {
    ...
    getSettings.mockResolvedValue({ defaultModelId: 'deepseek-v4-flash', defaultOutputMode: 'markdown', themeMode: 'system', themeId: 'hesper', fontSize: 14, soul: '' })
  ...
  it('opens and saves session category settings from the category context menu', async () => {
    ...
    expect(dialog).toHaveTextContent('分类设置')
    ...
    await user.selectOptions(screen.getByLabelText('默认模型'), 'gpt-4o')
