...
const fallbackBuiltinTools: ToolDto[] = [
  ...
  { id: 'roles.create', name: 'Create Role', description: 'Create a user-defined role with a name, description, full prompt, and default tools.', category: 'agent', icon: '🎭', inputSchema: { type: 'object', required: ['name'], properties: { name: { type: 'string' }, description: { type: 'string' }, systemPrompt: { type: 'string' }, defaultToolIds: { type: 'array', items: { type: 'string' } }, defaultModelId: { type: 'string', description: 'Default model id for this role. Empty string means inherit the caller/parent model.' }, defaultModelRef: { type: 'object', description: 'Provider-aware model reference. Only used with a non-empty defaultModelId.', properties: { providerId: { type: 'string' }, modelId: { type: 'string' } } } } }, enabled: true },
  { id: 'roles.update', name: 'Update Role', description: 'Update an existing user-defined role. This tool cannot delete roles.', category: 'agent', icon: '🎭', inputSchema: { type: 'object', required: ['id'], properties: { id: { type: 'string' }, name: { type: 'string' }, description: { type: 'string' }, systemPrompt: { type: 'string' }, defaultToolIds: { type: 'array', items: { type: 'string' } }, defaultModelId: { type: 'string', description: 'Default model id for this role. Empty string means inherit the caller/parent model.' }, defaultModelRef: { type: 'object', description: 'Provider-aware model reference. Only used with a non-empty defaultModelId.', properties: { providerId: { type: 'string' }, modelId: { type: 'string' } } } } }, enabled: true },
