...
const hesperApi = {
  sessions: {
    ...
    restore: (id) => ipcRenderer.invoke(ipcChannels.sessionsRestore, id),
    setMarked: (input) => ipcRenderer.invoke(ipcChannels.sessionsSetMarked, input),
  ...
  providers: {
    ...
    cancelOAuthAuthorization: (input) => ipcRenderer.invoke(ipcChannels.providersCancelOAuthAuthorization, input),
